...
- Díaz Anavia Javier Omar : 421106620
- Mejía Reyes Juan Daniel : 315096615
...
text
motor-juegos-multijugador-local/
├── engine-api/          # Contratos públicos para los juegos
├── engine-core/         # Servicios y ciclo principal del motor
├── platform-lwjgl3/     # Inicio de la aplicación de escritorio
├── launcher/            # Menú y selección de juegos
├── games/               # Juegos demostrativos
├── assets/              # Imágenes, fuentes, mapas y audio
└── docs/                # Arquitectura y documentación del proyecto

Esta estructura es preliminar y se implementará de manera incremental. La regla principal será que los juegos puedan utilizar la API del motor, pero el núcleo del motor no dependa de un juego concreto.
...
4. Solicitar la revisión de al menos otro integrante.
5. Resolver observaciones y verificar las pruebas disponibles.
6. Integrar el cambio manteniendo `main` en un estado estable.

Las responsabilidades de coordinación, revisión, integración y documentación se rotarán entre los integrantes para compartir el conocimiento del proyecto. Los roles están por asignarse.
